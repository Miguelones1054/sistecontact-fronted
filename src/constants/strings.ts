export const APP_STRINGS = {
  ...
  profile: {
    ...
    calendarSubtitle:
      'Si inicias sesión con Google, el calendario se vincula automáticamente. También puedes conectarlo aquí.',
  ...
  login: {
    ...
    googleSubmitting: 'Conectando con Google...',
    orDivider: 'o',
    switchToRegister: '¿No tienes cuenta? Registrarse',
    ...
    errors: {
      ...
      emailAlreadyInUse: 'Ese correo ya tiene una cuenta. Inicia sesión o usa Google.',
      weakPassword: 'La contraseña es demasiado débil. Usa al menos 6 caracteres.',
      popupClosed: 'Se cerró la ventana de Google. Inténtalo de nuevo.',
      popupBlocked: 'El navegador bloqueó la ventana de Google. Permite ventanas emergentes.',
      accountExistsDifferent:
        'Ese correo ya está registrado con otro método. Entra con correo y contraseña.',
      noAccess:
        'No tienes membresía activa. Actívala en www.nodefex.com/sistecontact',
      generic: 'No se pudo iniciar sesión. Inténtalo de nuevo.',
      genericRegister: 'No se pudo crear la cuenta. Inténtalo de nuevo.',
      genericGoogle: 'No se pudo continuar con Google. Inténtalo de nuevo.',
      googleCallback: 'No se pudo completar el inicio con Google. Inténtalo de nuevo.',
    },
  },
  search: {
  ...
  business: {
    ...
    whoVisitedTitle: 'Asesores en este comercio',
    whoVisitedEmpty: 'Ningún asesor tiene este comercio en prospectos, visitas o contactos aún.',
    whoVisitedLoading: 'Cargando visitantes...',
    whoVisitedError: 'No se pudieron cargar los visitantes',
    whoVisitedResult: 'Estado',
    whoScheduled: 'Citas programadas',
    whoScheduledTitle: 'Citas programadas en este comercio',
    whoScheduledEmpty: 'Nadie tiene una cita o llamada programada aquí aún.',
    whoScheduledLoading: 'Cargando citas...',
    whoScheduledError: 'No se pudieron cargar las citas programadas',
    whoScheduledDate: 'Visita',
    whoScheduledCall: 'Llamada',
    youLabel: 'Tú',
  },
} as const
